...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SP SONS</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/')}}/view-agency-name" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Agency Detail</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/')}}/view-master-form" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Master Form</p>
                </a>
              </li>

              <li class="nav-item">
                <a href="{{url('/')}}/view-app-list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Application List</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/')}}/view-medical-form" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Medical Form</p>
                </a>
              </li>
            </ul>
          </li>
  ...
  <?php $agency = DB::table('users')->where('agency_name','!=','')->count(); ?>
...
<script src="{{url('/')}}/dashboard_assets/plugins/datatables/jquery.dataTables.min.js"></script>
